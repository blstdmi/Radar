...
class GLMap : InputAdapter(), ApplicationListener, GameListener {
    ...
    override fun keyDown(keycode: Int): Boolean {
        ...
        // Change Player Info
            NUMPAD_1 -> {if (nameToggles < 6) {nameToggles += 1}
                if (nameToggles == 6) {nameToggles = 1}
            }

        // Other Filter Keybinds
            NUMPAD_2 -> drawcompass = drawcompass * -1
            F12 -> drawgrid = drawgrid * -1
        ...
        // Icon Filter Keybinds
            ...
            NUMPAD_3 -> filterThrow = filterThrow * -1
